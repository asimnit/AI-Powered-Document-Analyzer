...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Small delay to allow browser to detect successful login
      setTimeout(() => {
        navigate('/');
      }, 100);
    } catch (err) {
        ...
        <div className="bg-white/70 backdrop-blur-lg rounded-2xl shadow-2xl p-8 border border-white/20">
          ...
          <div className="text-center mb-8">
            ...
            <p className="mt-2 text-sm text-gray-600">
              Sign in to access your AI Document Analyzer
            </p>
          </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-gray-600">
              ...
              <Link to="/register" className="font-medium text-transparent bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text hover:from-blue-700 hover:to-purple-700 transition-all">
                Sign up
              </Link>
            </p>
          </div>
